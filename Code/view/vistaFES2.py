...
class Ui_Form(object):
	...
	def setupUi(self, Form):
		...
		self.calibbutt = QtWidgets.QPushButton(Form)
		self.calibbutt.setGeometry(QtCore.QRect(340, 390, 211, 41))
		font = QtGui.QFont()
		font.setPointSize(14)
		font.setBold(True)
		font.setWeight(75)
		...
		self.emglistenerbutt = QtWidgets.QPushButton(Form)
		self.emglistenerbutt.setGeometry(QtCore.QRect(350, 340, 181, 41))
		font = QtGui.QFont()
		font.setPointSize(14)
		font.setBold(True)
		font.setWeight(75)
	...
	def retranslateUi(self, Form):
		...
		self.numerocomdisp.setText(_translate("Form", "4"))
	...
	#Building************************************************************easy UI--
	def onTextChangedComNum(self):
		# model.getList.get()
		# model.setCurrentPort
		self.numberCOM = str(self.numerocomdisp)
...
class LThread(QThread):
	...
	def run(self):
		...
		while True:
			...
			if sample > Ui_Form.devices.emgdev.calibration_threshold:
				print("llego")
