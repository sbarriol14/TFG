...
# Building**?
# Thread in charge of the EMG process
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.exitbutt2.setText(_translate("Form", "Exit"))
        self.conectarcombutt.setText(_translate("Form", "Conect COM"))
        self.infochannels.setTitle(_translate("Form", "Channels (Parameters Set)"))
        self.channtablab.setText(_translate("Form", "Channels"))
        ...
        self.deconectccombutt.setText(_translate("Form", "Disconnect COM"))
        self.paramframe.setTitle(_translate("Form", "Channel parameters"))
        self.maskbutt.setText(_translate("Form", "Set Mask"))
        self.currentbutt.setText(_translate("Form", "Current (mA)"))
        self.freqbutt.setText(_translate("Form", "Freq (Hz)"))
        ...
        self.currentnum.setText(_translate("Form", "10"))
        ...
        self.sendparambutt.setText(_translate("Form", "Send parameters"))
        self.channelselecframe_2.setTitle(_translate("Form", "Select channel"))
    ...
    # Permits to define in wich COM port is the TremUna connected eg COM3 -> 3
    ...
    # self.devices.fesdev.initialize('COM3')    #manual port set
    ...
    # Shuts down FES device and sets mask to 0
    ...
    def onClickMaskButt(self):
        ...
        Ui_Form.devices.fesdev.stimulation(maskarade)

    # Initiating listener and stimulator threads
    lthreader = LThread()
    sthreader = SThread()
    ...
    # Calibrates threshold for EMG activations detection
    ...
    def onClickStopemg(self, threader):
        try:
            Ui_Form.lthreader.terminate()
            Ui_Form.lthreader.terminate()
            print("EMG proccess Stopped")
        except:
            print("EMG procces stopping error, if problem shut down TremUna for security")
    ...
    def onClickSendParamButt(self):
        print("Sending parameters to FES device")
        if self.fcheckch1.isChecked():
